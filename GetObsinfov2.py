...
def test_instrument(instrument, valid):
    GRANDMA = {'SBO', 'SRO', 'TCA', 'TCH', 'TRE', 'FZU-Auger', 'FZU-CTA-N', 'Xinglong-2.16m', 'TNT', 'SNOVA', 'ALi-50', 'OPD-1.6m', 'OPD-60', 'SOAR', 'Abastumani-T70', 'Abastumani-T48', 'C2PU', 'GMG', 'UBAI-T60N', 'UBAI-T60S',
               'Makes-T60', 'MOSS', 'OWL', 'TRAPPIST', 'ShAO-T60', 'ShAO-2m', 'CAHA', 'VIRT', 'OST', 'PicDuMidi-T1M', 'CFHT', 'GTC', 'TELESCO', 'KAO', 'NOWT', 'Xinglong-2.16m', 'OST-CDK', 'Lisnyky', 'ShAOT60', 'UBAI-ST60', 'CFHT-Megacam', "ASTEP"}

    KNC = {'C11FREE', 'HAN', 'K26', 'SUTO1', 'SUTO2', 'T-BRO', 'T-CAT',
           'TJML', 'TJMS-PLANETE-SCIENCES', 'T-AGU', 'T19', 'HAO', 'T24', 'T21'}
...
def Cformatandcollectinfo(filename):
    ...
    for filefits in data_fits:
        ...
        try:
            date = hdr["OBSDATE"]
            obs.obserdate = date.split(
                'T')[0]+'T'+date.split('T')[1].replace('-', ':')
        ...
        # print(valid)
        if valid == 0:
            print("Format problem in "+str(filefits), "inexistant keywords: " +
                  addusername+addinstru+addobsdate+addfilter+addtarget+addstack+addexp)
    return obs
